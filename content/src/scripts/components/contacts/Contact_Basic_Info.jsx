...
class ContactBasicInfo extends Component{
  ...
  createContactRequest(){
    ...
    this.state.newCustomFieldsArray.map((field,key)=>
                            reqObj["frmFld_"+encodeHTML(Object.keys(field)[0])] = encodeHTML(field[Object.keys(field)[0]])
                        );
    console.log(reqObj);
            ...
            reqObj['company'] = encodeHTML(this.state.company)
            reqObj['telephone'] = encodeHTML(this.state.telephone)
            reqObj['city']= encodeHTML(this.state.city)
            reqObj['state']= encodeHTML(this.state.state)
            reqObj['address1']= encodeHTML(this.state.address1)
            reqObj['jobStatus']= encodeHTML(this.state.jobStatus)
            reqObj['salesRep']= encodeHTML(this.state.salesRep)
            reqObj['salesStatus']= encodeHTML(this.state.salesStatus)
            reqObj['birthDate']= encodeHTML(this.state.birthDate)
            reqObj['areaCode']= encodeHTML(this.state.areaCode)
            reqObj['country']= encodeHTML(this.state.country)
            reqObj['zip']= encodeHTML(this.state.zip)
            reqObj['address2']= encodeHTML(this.state.address2)
            reqObj['industry']= encodeHTML(this.state.industry)
            reqObj['source']= encodeHTML(this.state.source)
            reqObj['occupation']= encodeHTML(this.state.occupation)
